       ...
       ("ce <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.916290731874155), ("verano", -2.0149030205422647),
                                    ("fin de semana", -1.6094379124341003),
                                    ("invierno", -2.0149030205422647),
                                    ("Lunes", -2.0149030205422647)],
                               n = 5},
                   koData =
                     ...
                     ClassData{prior = -0.6795415285041666, unseen = -4.382026634673881,
                               likelihoods =
                                 HashMap.fromList
                                   [("<hour-of-day> <integer> (as relative minutes)",
                                     -1.8044984950054848),
                                    ("minute", -1.8044984950054848),
                                    ("time-of-day (latent)", -1.1113513144455396),
                                    ("hour", -1.1113513144455396)],
                               n = 37}}),
       ("del mediod\237a",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("el <time>",
        Classifier{okData =
                     ClassData{prior = -2.5317807984289897e-2,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.9490805546971459), ("year", -3.4339872044851463),
                                    ...
                                    ("<day-of-month> (ordinal or number) de <named-month>",
                                     -2.0476928433652555),
                                    ("hour", -3.4339872044851463), ("dd[/-]mm", -3.146305132033365),
                                    ("<named-month|named-day> past", -3.4339872044851463),
                                    ("Lunes", -3.8394523125933104),
       ...
       ("this|next <day-of-week>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.3025850929940455,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.8109302162163288), ("Viernes", -1.0986122886681098),
                                    ("Lunes", -1.5040773967762742)],
                               n = 3},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -3.028522096376982),
                                    ...
                                    ("minute", -2.3353749158170367), ("month", -3.028522096376982),
                                    ("hour", -2.3353749158170367),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.890371757896165),
                                    ...
                                    ("second", -2.890371757896165), ("minute", -2.890371757896165),
                                    ("month", -2.6026896854443837), ("hour", -2.890371757896165),
                                 ...
                                 HashMap.fromList
                                   [("<time-of-day> am|pm", -2.5649493574615367),
                                    ...
                                    ("<hour-of-day> minus quarter (as relative minutes)",
                                     -4.0312864262549635),
                                    ("minute", -1.4923125551966876),
                                    ("time-of-day (latent)", -1.4163266482187657),
                                    ("hour", -1.3686985992295109),
       ...
       ("<named-month|named-day> next",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.3978952727983707,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.916290731874155), ("el <time>", -1.6094379124341003),
       ...
       ("two time tokens separated by \",\"",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
                                   [("Viernesel <day-of-month> (non ordinal)", -2.5649493574615367),
