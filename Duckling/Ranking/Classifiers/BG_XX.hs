        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -3.4339872044851463,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.70805020110221), ("hour (grain)", -2.70805020110221),
       ...
       ("<named-month> year",
        Classifier{okData =
                     ClassData{prior = -1.0986122886681098, unseen = -1.791759469228055,
                               likelihoods =
                                 HashMap.fromList
                                   [("month", -0.916290731874155), ("October", -0.916290731874155)],
                               n = 1},
                   koData =
       ...
       ("this|next <day-of-week>",
        Classifier{okData =
                     ClassData{prior = -0.40546510810816444,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.9808292530117262), ("Tuesday", -1.3862943611198906),
                   ...
                   koData =
                     ClassData{prior = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.0986122886681098), ("Friday", -1.0986122886681098)],
                               n = 1}}),
       ...
       ("<time> after next",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.6931471805599453), ("Friday", -0.6931471805599453)],
                               n = 1},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.0986122886681098,
                               likelihoods = HashMap.fromList [], n = 0}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.5040773967762742), ("Tuesday", -1.5040773967762742),
                                    ("March", -1.5040773967762742), ("month", -1.5040773967762742)],
                               n = 2},
                   koData =
                     ClassData{prior = -1.0986122886681098,
                               unseen = -2.0794415416798357,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.252762968495368), ("Friday", -1.252762968495368)],
                               n = 1}}),
       ("tonight",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("<time-of-day> am",
        Classifier{okData =
                     ClassData{prior = -0.2876820724517809,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hh:mm", -1.7047480922384253), ("minute", -1.7047480922384253),
       ...
       ("at <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.1823215567939546, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("hh:mm", -2.0149030205422647), ("minute", -2.0149030205422647),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.3978952727983707,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.916290731874155), ("winter", -1.6094379124341003),
