                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>", -2.1400661634962708),
                                    ("year", -2.1400661634962708), ("second", -1.4469189829363254),
       ...
       ("absorption of , after named day",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.1354942159291497,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.8938178760220964), ("Friday", -1.9924301646902063),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..19st)TuesdaySeptember", -1.791759469228055),
                                    ...
                                    ("ordinals (first..19st)WednesdayOctober",
                                     -1.2809338454620642)],
                               n = 6}}),
       ("lunch",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)hour (grain)", -2.9267394020670396),
                                    ...
                                    ("month", -2.639057329615259), ("hour", -2.9267394020670396),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.11778303565638351,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("morning", -0.750305594399894), ("hour", -0.750305594399894)],
                               n = 16}}),
       ("new year's day",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("this|next <day-of-week>",
        Classifier{okData =
                     ClassData{prior = -0.5596157879354228, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.9555114450274363), ("Tuesday", -1.466337068793427),
                   ...
                   koData =
                     ClassData{prior = -0.8472978603872037,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.0116009116784799), ("Friday", -1.2992829841302609),
       ...
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = -2.751535313041949, unseen = -2.833213344056216,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.6739764335716716), ("Tuesday", -2.0794415416798357),
                                    ("week-end", -2.0794415416798357),
                                    ("hour", -2.0794415416798357), ("Sunday", -2.0794415416798357)],
                               n = 3},
                   koData =
                     ClassData{prior = -6.59579677917974e-2, unseen = -4.59511985013459,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.3877429013343523), ("year", -1.6405284995041316),
                                    ("intersect by \"of\", \"from\", \"'s\"", -2.9755295662364714),
                                    ("time-of-day (latent)", -1.6405284995041316),
                                    ("year (latent)", -1.6405284995041316),
                                    ("hour", -1.6405284995041316), ("Sunday", -3.4863551900024623),
                                    ("Monday", -3.4863551900024623)],
                               n = 44}}),
       ("second (grain)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.3978952727983707,
       ...
       ("next <time>",
        Classifier{okData =
                     ClassData{prior = -0.587786664902119, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.2237754316221157), ("Tuesday", -1.7346010553881064),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.3217558399823195), ("March", -2.0149030205422647),
                                    ("Friday", -1.6094379124341003), ("month", -2.0149030205422647),
       ...
       ("<time> timezone",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.6109179126442243,
                               likelihoods =
                                 HashMap.fromList
                                   [("hh:mm", -1.5040773967762742), ("minute", -1.0185695809945732),
                                    ("hour", -1.9740810260220096),
       ...
       ("after <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -3.58351893845611,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.169053700369523), ("tomorrow", -2.169053700369523),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.456735772821304),
                                    ...
                                    ("minute", -2.8622008809294686), ("hour", -1.252762968495368),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906, unseen = -3.871201010907891,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.2407096892759584), ("morning", -3.1570004211501135),
                                    ("evening", -3.1570004211501135),
                                    ("week-end", -2.751535313041949),
                                    ("month", -2.2407096892759584), ("hour", -2.2407096892759584),
                                    ("next <cycle>", -3.1570004211501135),
                                    ("October", -2.751535313041949),
                   ...
                   koData =
                     ClassData{prior = -0.2876820724517809, unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
                                   [("March", -3.100092288878234), ("morning", -1.8763168572561182),
                                    ("month", -1.2755429968271879),
                                    ("time-of-day (latent)", -3.6109179126442243),
                                    ("hour", -1.7650912221458936), ("October", -2.3116349285139637),
