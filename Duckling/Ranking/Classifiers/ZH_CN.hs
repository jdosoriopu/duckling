                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.2617630984737906), ("year", -2.772588722239781),
                                    ...
                                    ("hour", -2.2617630984737906), ("week", -2.2617630984737906)],
                               n = 20}}),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -3.912023005428146,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.793208009442517), ("second", -2.505525936990736),
                                    ("<integer> <unit-of-duration>", -0.8007778447523107),
                                    ("minute", -2.2823823856765264), ("month", -2.2823823856765264),
                                    ("hour", -2.2823823856765264), ("week", -2.2823823856765264)],
                               n = 21}}),
       ("afternoon",
        Classifier{okData =
       ...
       ("this <day-of-week>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.970291913552122,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.7323678937132265), ("Tuesday", -1.5533484457830569),
       ...
       ("last n <cycle>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.9856819377004897),
                                    ("integer (0..10)hour (grain)", -2.3978952727983707),
                                    ("year", -3.4965075614664802),
                                    ...
                                    ("minute", -2.3978952727983707), ("month", -2.1972245773362196),
       ...
       ("next n <cycle>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.515678308454754),
                                    ("integer (0..10)hour (grain)", -2.3978952727983707),
                                    ("year", -3.2088254890146994),
                                    ...
                                    ("minute", -2.649209701079277), ("month", -2.803360380906535),
                                    ("hour", -2.3978952727983707),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -6.244166900663736,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -3.1067290495260154),
                                    ("integer (0..10)hour (grain)", -3.1067290495260154),
                                    ("year", -2.1646858215494458),
                                    ...
                                    ("number suffix: \21313|\25342minute (grain)",
                                     -4.855928904335275),
                                    ("month", -2.008116760857906), ("hour", -3.1067290495260154),
       ...
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.7308875085427924), ("Tuesday", -1.5040773967762742),
                                    ("Sunday", -1.2163953243244932)],
                               n = 12},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.3862943611198906,
                               likelihoods = HashMap.fromList [], n = 0}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.3978952727983707),
                                    ...
                                    ("minute", -2.908720896564361), ("month", -2.908720896564361),
                                    ("hour", -2.3978952727983707),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.8415671856782186), ("Tuesday", -1.6625477377480489),
                                    ("week-end", -2.9618307218783095),
                                    ("hour", -2.9618307218783095),
