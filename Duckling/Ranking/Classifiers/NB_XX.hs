       ...
       ("a <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.4965075614664802,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.772588722239781), ("year", -2.367123614131617),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..31st)TirsdagOktober", -1.9924301646902063),
                                    ("ordinals (first..31st)Tirsdagintersect", -1.9924301646902063),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)hour (grain)", -3.2771447329921766),
                                    ...
                                    ("month", -3.5648268054439574),
                                    ("integer (0..19)hour (grain)", -3.970291913552122),
                                    ("hour", -2.871679624884012),
       ...
       ("last <time>",
        Classifier{okData =
                     ClassData{prior = -1.6739764335716716, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.3862943611198906), ("week-end", -1.8971199848858813),
                                    ("hour", -1.8971199848858813), ("Tirsdag", -1.8971199848858813),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.8971199848858813),
                                    ...
                                    ("hour", -1.1499055830556604), ("Mandag", -2.995732273553991),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.276293465905562, unseen = -3.6375861597263857,
                               likelihoods =
                                 HashMap.fromList
                                   [("year", -2.917770732084279), ("on <date>", -2.512305623976115),
                                    ("time-of-day (latent)", -1.3083328196501787),
                                    ("year (latent)", -2.917770732084279),
                                    ("hour", -1.126011262856224)],
                               n = 12}}),
       ("last <cycle> of <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.1354942159291497,
       ...
       ("<time> timezone",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -3.7376696182833684,
                               likelihoods =
                                 HashMap.fromList
                                   [("hh:mm", -1.5163474893680884), ("minute", -1.0055218656020977),
                                    ("hour", -2.1041341542702074),
                     ...
                     ClassData{prior = -0.2488960474166244,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("relative minutes after|past <integer> (hour-of-day)",
                                     -3.865979066926739),
                                    ("hh:mm", -2.074219597698684), ("minute", -1.7557658665801497),
                                    ("time-of-day (latent)", -1.244940242814159),
                                    ("<time-of-day> sharp", -3.3063632789913164),
                                    ("hour", -1.1413995638733185),
       ...
       ("after <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.45198512374305727,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.0243817644968085), ("tomorrow", -2.0243817644968085),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = -1.2685113254635072,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.9661128563728327), ("morning", -2.8134107167600364),
                                    ("christmas days", -2.8134107167600364),
                                    ("Oktober", -2.8134107167600364),
                                    ("evening", -3.2188758248682006),
                                    ("week-end", -2.3025850929940455),
                                    ("month", -2.3025850929940455), ("hour", -1.8325814637483102),
                   ...
                   koData =
                     ClassData{prior = -0.33024168687057687,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Mars", -3.054001181677967), ("morning", -1.8302257500558512),
                                    ("Oktober", -2.2655438213136967),
                                    ("month", -1.2294518896269209), ("hour", -1.8302257500558512),
