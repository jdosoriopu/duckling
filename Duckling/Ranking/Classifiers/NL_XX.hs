       ...
       ("on a named-day",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.8472978603872037), ("friday", -1.9459101490553135),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.1972245773362196), ("hh:mm", -1.9095425048844386),
                                    ("dd/mm", -2.6026896854443837), ("minute", -1.5040773967762742),
       ...
       ("absorption of , after named day",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -0.8649974374866046), ("friday", -1.55814461804655),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)hour (grain)", -2.70805020110221),
                                    ...
                                    ("month", -2.70805020110221), ("hour", -2.70805020110221),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)hour (grain)", -1.4313180424938456),
                                    ...
                                    ("month", -3.459466289786131),
                                    ("integer (0..19)hour (grain)", -2.871679624884012),
                                    ("hour", -1.2402628057311365),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("month", -0.7731898882334817),
                                    ("October", -1.8718021769015913),
                                    ("July", -0.9555114450274363)],
                               n = 5},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.3862943611198906,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ("next <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.1786549963416462), ("week-end", -1.8718021769015913),
                                    ("hour", -1.8718021769015913),
                                    ("wednesday", -1.8718021769015913),
                                    ("monday", -1.466337068793427)],
                               n = 4},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.791759469228055,
                               likelihoods = HashMap.fromList [], n = 0}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.3978952727983707),
                                    ...
                                    ("minute", -2.3978952727983707), ("hour", -1.9924301646902063),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)time-of-day (latent)", -1.7047480922384253),
                                    ("minute", -1.7047480922384253), ("hour", -1.2992829841302609),
       ...
       ("this <time>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.4849066497880004,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.2992829841302609), ("winter", -1.7047480922384253),
